...
LOCAL_EXPORT_C_INCLUDES += $(LOCAL_PATH)/../../../SoundEngine/Android/libzip/lib
...
LOCAL_LDLIBS := -llog -lOpenSLES -landroid -lEGL -lGLESv1_CM -lz
...
ifeq ($(TARGET_ARCH_ABI)$(HF), armeabi-v7a-hf)
