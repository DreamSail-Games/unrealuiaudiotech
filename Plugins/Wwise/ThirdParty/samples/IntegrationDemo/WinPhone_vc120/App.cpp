...
{
	int x = (int) ( (double) args->CurrentPoint->Position.X / m_deviceResources->GetLogicalSize().Width * m_deviceResources->GetRenderTargetSize().Width );
	int y = (int) ( (double) args->CurrentPoint->Position.Y / m_deviceResources->GetLogicalSize().Height * m_deviceResources->GetRenderTargetSize().Height );
	IntegrationDemo::Instance().OnPointerEvent( PointerEventType_Pressed, x, y );
...
void App::OnPointerMoved(CoreWindow^ sender, PointerEventArgs^ args)
{
	int x = (int) ( (double) args->CurrentPoint->Position.X / m_deviceResources->GetLogicalSize().Width * m_deviceResources->GetRenderTargetSize().Width );
	int y = (int) ( (double) args->CurrentPoint->Position.Y / m_deviceResources->GetLogicalSize().Height * m_deviceResources->GetRenderTargetSize().Height );
	IntegrationDemo::Instance().OnPointerEvent( PointerEventType_Moved, x, y );
...
void App::OnPointerReleased(CoreWindow^ sender, PointerEventArgs^ args)
{
	int x = (int) ( (double) args->CurrentPoint->Position.X / m_deviceResources->GetLogicalSize().Width * m_deviceResources->GetRenderTargetSize().Width );
	int y = (int) ( (double) args->CurrentPoint->Position.Y / m_deviceResources->GetLogicalSize().Height * m_deviceResources->GetRenderTargetSize().Height );
	IntegrationDemo::Instance().OnPointerEvent( PointerEventType_Released, x, y );
...
{
	IntegrationDemo::Instance().OnBack();
	args->Handled = true;
}
