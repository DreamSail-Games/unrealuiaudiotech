...
- (void)loadView
{
	...
	m_buttons = [[NSDictionary alloc] initWithObjectsAndKeys:
		[UIButton buttonWithType:(UIButtonType)UIButtonTypeRoundedRect], [NSNumber numberWithInteger:UG_DPAD_UP],
        [UIButton buttonWithType:(UIButtonType)UIButtonTypeRoundedRect], [NSNumber numberWithInteger:UG_DPAD_LEFT],
        [UIButton buttonWithType:(UIButtonType)UIButtonTypeRoundedRect], [NSNumber numberWithInteger:UG_DPAD_DOWN],
		[UIButton buttonWithType:(UIButtonType)UIButtonTypeRoundedRect], [NSNumber numberWithInteger:UG_DPAD_RIGHT],
		[UIButton buttonWithType:(UIButtonType)UIButtonTypeRoundedRect], [NSNumber numberWithInteger:UG_BUTTON1],
		[UIButton buttonWithType:(UIButtonType)UIButtonTypeRoundedRect], [NSNumber numberWithInteger:UG_BUTTON2],
		[UIButton buttonWithType:(UIButtonType)UIButtonTypeRoundedRect], [NSNumber numberWithInteger:UG_BUTTON3],
		[UIButton buttonWithType:(UIButtonType)UIButtonTypeRoundedRect], [NSNumber numberWithInteger:UG_BUTTON4],
		[UIButton buttonWithType:(UIButtonType)UIButtonTypeRoundedRect], [NSNumber numberWithInteger:UG_BUTTON7],
		[UIButton buttonWithType:(UIButtonType)UIButtonTypeRoundedRect], [NSNumber numberWithInteger:UG_BUTTON8],
		nil];
									   ...
									   usingBlock:^(id key, id obj, BOOL *stop) 
	{
		@synchronized(m_buttons)
		{
			...
			[it addTarget:self action:@selector(buttonUp:) 
				forControlEvents: (UIControlEventAllEvents && ~UIControlEventPrimaryActionTriggered)];
...
- (void) rotateToOrientation
{
    ...
    CGRectMake(viewRect.size.width-200-m_marginSize,m_marginSize+30,200,30);
    ...
    CGRectMake(m_marginSize,m_marginSize+30,200,30);
