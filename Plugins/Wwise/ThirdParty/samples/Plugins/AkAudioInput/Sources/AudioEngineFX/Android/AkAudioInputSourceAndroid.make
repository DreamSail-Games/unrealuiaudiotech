...
ifeq ($(config),debug_armeabi-v7a)
  ...
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -g -O3 -march=armv7-a -mfloat-abi=softfp -mfpu=neon -fvisibility=hidden
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS) -Wno-invalid-offsetof -fno-rtti -fno-exceptions -Wno-deprecated-declarations
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -march=armv7-a -mfloat-abi=softfp -mfpu=neon
  LDDEPS    +=
  LIBS      += $(LDDEPS)
...
ifeq ($(config),release_armeabi-v7a)
  ...
  TARGET     = $(TARGETDIR)/libAkAudioInputSource.a
  DEFINES   += -DNDEBUG -DAK_OPTIMIZED -DAUDIOKINETIC
  INCLUDES  += -I. -I.. -I../../../../../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -g -O3 -march=armv7-a -mfloat-abi=softfp -mfpu=neon -fvisibility=hidden
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS) -Wno-invalid-offsetof -fno-rtti -fno-exceptions -Wno-deprecated-declarations
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking AkAudioInputSourceAndroid
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning AkAudioInputSourceAndroid
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
